#' @title Mississippi Floodwalls (USACE)
#'
#' @description Mississippi Floodwalls (USACE) data from National Levee Database.
#' A structure erected to restrict the intrusion of floodwaters into the leveed area.
#'
#' @format SF tibble. 16 X 77 LINESTRING.
