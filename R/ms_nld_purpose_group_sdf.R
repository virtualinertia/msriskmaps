#' @title Mississippi Purpose Groups
#'
#' @description Mississippi Purpose Group data from National Levee Database.
#'
#' @format SF tibble. 6,174 X 23 POINT.
