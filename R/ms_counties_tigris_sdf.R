...
#'
#' @description Mississippi Counties boundaries from U.S. Census TIGER database.
#' Used for subsetting NLD, NID, NBI and other features from nation-wide layers,
#' or for subsetting MS-wide layers to individual MS counties.
#'
#' @format SF tibble. 82 X 18 MULTIPOLYGON
#'
#' @details
