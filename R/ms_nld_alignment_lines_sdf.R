#' @title Mississippi Alignment Lines
#'
#' @description Mississippi Alignmen Lines data from National Levee Database
#'
#' @format SF tibble. 184 X 24 GEOMETRY
