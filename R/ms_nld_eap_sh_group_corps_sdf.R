#' @title Mississippi Emergency Action Plan SH Group (USACE)
#'
#' @description Mississippi Emergency Action Plan SH Group (USACE) data from National Levee Database.
#'
#' @format SF tibble. 10 X 23 POINT.
