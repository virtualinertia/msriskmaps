#' @title Mississippi Warrren County
#'
#' @description Mississippi Warren County boundaries from U.S. Census TIGER database.
#' Used for subsetting NLD, NID, NBI and other features from nation-wide layers,
#' or for subsetting MS-wide layers to Warren County.
#'
#' @format SF tibble. 1 X 18 MULTIPOLYGON
#'
#' @details
