#' @title Mississippi Pipes (USACE)
#'
#' @description Mississippi Pipes (USACE) data from National Levee Database.
#' A structure designed to allow flow of water from the interior of a levee unit to the waterside.
#'
#' @format SF tibble. 168 X 46 LINESTRING.
