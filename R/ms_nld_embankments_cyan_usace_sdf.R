#' @title Mississippi Embankments (USACE)
#'
#' @description Mississippi Embankments (USACE) data from National Levee Database.
#' Embankment to restrict the intrusion of floodwaters into the leveed area.
#' Unsure why "cyan" (suspect ArcGIS rendering theme).
#'
#' @format SF tibble. 40 X 77 GEOMETRY.
...
"ms_nld_embankments_cyan_usace_sdf"
