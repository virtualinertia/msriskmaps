#' @title Mississippi Emergency Action Plan HH Group
#'
#' @description Mississippi Emergency Action Plan HH Group data from National Levee Database.
#'
#' @format SF tibble. 347 X 23 POINT
