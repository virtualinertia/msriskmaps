#' @title Mississippi Leveed Areas (USACE)
#'
#' @description Mississippi Leveed Area (USACE) data from National Levee Database.
#' Subset to only Mississippi.
#' The area of a floodplain from which flood water is excluded by the levee system.
#'
#' @format SF tibble. 24 X 42 POLYGON
