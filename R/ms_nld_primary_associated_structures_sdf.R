#' @title Mississippi Primary Associated Structures
#'
#' @description Mississippi Primary Associated Structures data from National Levee Database.
#'
#' @format SF tibble. 6,093 X 19 POINT.
...
"ms_nld_primary_associated_structures_sdf"
