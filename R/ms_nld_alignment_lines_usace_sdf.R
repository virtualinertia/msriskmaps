#' @title Mississippi Alignment Lines (USACE)
#'
#' @description Mississippi Alignment Lines (USACE) data from National Levee Database
#'
#' @format SF tibble.
...
"ms_nld_alignment_lines_usace_sdf"
