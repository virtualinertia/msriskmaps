#' @title Mississippi Emergency Action Plan HH Group (USACE)
#'
#' @description Mississippi Emergency Action Plan HH Group (USACE) data from National Levee Database.
#'
#' @format SF tibble. 8 X 23 POINT
