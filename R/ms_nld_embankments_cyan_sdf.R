#' @title Mississippi Embankments
#'
#' @description Mississippi Embankments data from National Levee Database.
#' Embankment to restrict the intrusion of floodwaters into the leveed area.
#' Unsure why "cyan" (suspect ArcGIS rendering theme).
#'
#' @format SF tibble. 183 X 77 GEOMETRY
