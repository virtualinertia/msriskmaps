#' @title Mississippi Emergency Action Plan SH Group
#'
#' @description Mississippi Emergency Action Plan SH Group data from National Levee Database.
#'
#' @format SF tibble. 70 X 23 POINT.
